...
class Film {
  ...
  getDetailedCard = (content) => {
    ...
    let img = makeTag(
      "img",
      "img-responsive rounded-start poster-settings",
      null,
      null,
      content.url
    );
    ...
    let pSinopsis = makeTag(
      "p",
      "card-text pCard",
      null,
      "Sinopsis: " + content.sinopsis
    );
    let pDirection = makeTag(
      "p",
      "card-text pCard",
      null,
    ...
    this.setEditBtn();
    cardBodyDiv.appendChild(this.getEditBtn());
  ...
  setEditBtn = () => {
    ...
    this.editBtn.setAttribute("id", "editCard");
    this.editBtn.setAttribute("class", "btn btn-secondary btnFilmDetails");
    this.editBtn.setAttribute("onclick", "editFilm()");
  };
